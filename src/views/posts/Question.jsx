...
function Question() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-5">
      <div className="text-slate-700 text-[32px] font-bold mb-3">질문하기</div>

      <form onSubmit={submitHandler}>
        <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
          <div className="flex justify-between items-center text-gray-600 py-2 px-3 border-b dark:border-gray-200 bg-slate-50 font-bold">
            <div className="flex flex-wrap items-center w-6/12 divide-gray-200 dark:divide-gray-600 text-gray-600 text-[20px] font-bold">
              <div className="flex w-2/12 pl-1 items-center">제목</div>
            ...
            <div className="flex flex-wrap items-center w-3/12">
              ...
              <select
                id="countries"
                className="w-7/12 text-slate-600 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
