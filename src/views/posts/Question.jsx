...
function Question() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-3">
      <div className="text-slate-700 text-[32px] font-bold">
        질문하기
      </div>
        ...
        <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
          <div className="flex justify-between items-center py-2 px-3 border-b dark:border-gray-600">
            ...
            <div className="flex flex-wrap items-center w-3/12">
              ...
              <select 
                ...
                value = {college}
              >
                <option defaultValue="Humanities" value="Humanities">인문</option>
          ...
          <div className="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
              ...
              <textarea 
                id="editor" 
                rows="8"
                className="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:placeholder-gray-400" placeholder="질문을 입력해주세요" required
                value = {message}
